...
class DashboardController extends Controller
{
    ...
    //Thống kê số dư tài khoản dựa trên thu nhập và chi tiêu của người dùng trong năm hiện tại.
    ...
    // Thống kê thu nhập hoặc chi tiêu hàng tháng trong năm hiện tại.
    ...
    // Thống kê thu nhập hoặc chi tiêu hàng tuần trong tuần hiện tại.
    ...
    //Thống kê thu nhập hoặc chi tiêu hàng năm.
    ...
    //Lấy danh sách các giao dịch thu nhập hoặc chi tiêu gần nhất trong tuần hiện tại.
	 ...
	 * @return object
	 */
    //Thống kê thu nhập hoặc chi tiêu theo danh mục trong khoảng thời gian tuần, tháng hoặc năm.
    ...
    //Hiển thị tất cả các giao dịch gần nhất, hỗ trợ cho giao diện di động.
